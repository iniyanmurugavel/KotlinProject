fun main(args:Array<String>){
    ...
    /**
     * In oops ,an extension method is a method added to an object after the original object was compiled
     * Why extensions
     ...
     *
     * With generic classes ,extension methods allow implementation of the behaviour that is avialble for all
