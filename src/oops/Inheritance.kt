...
fun main(args: Array<String>) {
    ...
    /**
     * In oops  inheritance enables new object to take on the properties of existing objects
     * we can call super class or base class
     * A class that inherits from superclass is a subclass or derived class
     * Why we use inheritance
     * oops.Animal have a attributes for every animal , cat is also an animal ,
    ...
    println("My oops.Person " + myPerson.name)
    ...
    println("My oops.Student " + myStudent.name)
    println("My oops.Student " + myStudent.StudentId!!)
...
class student() : Person() { // inherits from person class
    // oops.Person class by default is final how to change the situation
    // if you use make class open then you can make inheritance from person
    // oops.student class get all the properties from person class
