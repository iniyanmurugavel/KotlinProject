...
fun main(args :Array<String>){
    ...
    /**
     * Method Overriding
     * IN oops Method overriding is a language feature that allows a subclass to provide a specific implementation
...
open class AnimalX(){
     ...
     */
   open fun fight(){
        println("oops.AnimalX is fighting")
    }
...
class Tiger: AnimalX(){
    ...
    override fun fight() {
        ...
        println("oops.Tiger is fighting")
    }
}