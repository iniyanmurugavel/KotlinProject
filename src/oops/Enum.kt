...
fun main(args : Array<String>){
     ...
     * An Enumeration is a oops.user-defined data type that consist of integral constants
     * Why we should enum actually?
     * we should always use enum when a variable can only take one out of small set of possible values
