...
fun main(args : Array<String>){
     ...
     * Car objects what is model of the oops.car , speed of oops.car , power of oops.car
     ...
     * ex oops.car - object inside some attributes the blueprints shows the attritubes
     *  model of oops.car and no of wheels
    ...
    yourcar.power=200;
    println("your oops.car  "+yourcar.power) // property of the yourcar is differet from mycar object because it has own property
...
class car {
    ...
    /**
     * Attribute of the oops.car object
     * These all declearation are the properties of the oops.car objects
     */
