fun main(args :Array<String>){
     ...
     * Animal have a attributes for every animal , cat is also an animal ,
   ...
   myPerson.name="iniyan"
    ...
    println("My Person "+myPerson.name)
    ...
    println("My Student "+myStudent.name)
    println("My Student "+myStudent.StudentId!!)
...
class student() : Person(){ // inherits from person class
    // Person class by default is final how to change the situation
    // if you use make class open then you can make inheritance from person
    // student class get all the properties from person class
