...
fun main(args:Array<String>){
  ...
  //  lion.join() // this method will all the lion values first next it will go to other threads
    ...
    var tiger= AnimalThread("kt.oops.Tiger")
    tiger.start()
...
//         // can access background thread not kt.oops.user interface thread
//        }
//
//        override  fun onPostExecute (result: List<T>){
//        // can access kt.oops.user interface thread Not a background thread
//        }
//    }
