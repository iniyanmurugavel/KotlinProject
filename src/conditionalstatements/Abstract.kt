...
fun main(args:Array<String>){
   ...
   // var myabstractcls=conditionalstatements.AnimalClass() //can't create a instance of an abstract class // abstract class can't be instantiated
...
//    }
     ...
     override fun getValue(): String {
        TODO("Not yet implemented")
        return  "abstract overrided method"
    }
