fun main(args :Array<String>){
    ...
    /**
     * why we go for list
     * ex Assume that you finally invite you friend name and you want to add to invite him/her to the party
     ...
     * if oyu go with index strart from 0 then size should be size - 1 or else it will through arrayoutofboundexception
